  ...
  return (
    <>
      <div className="wrong-answer py-3">
        ...
        <div>Name a Pokemon with the letter <span className="text-uppercase filtered-pokes-numbers">{randomLetter}</span> and get <span className="text-uppercase filtered-pokes-numbers">{points}</span> points!</div>
        <div> <span className="text-uppercase filtered-pokes-numbers">{filteredPokes.length}</span> Pokemon start with the letter with the letter  <span className="text-uppercase filtered-pokes-numbers">{randomLetter}</span></div>
